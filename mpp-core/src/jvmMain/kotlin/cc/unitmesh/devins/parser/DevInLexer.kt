...
/**
 * DevIn Language Lexer for JVM platform
 * 
 * This is a basic implementation for JVM that provides minimal functionality
 * for DevIn language tokenization. For full functionality, use the IntelliJ
        ...
        while (pos < input.length) {
            ...
            when {
                ...
                char == '|' && pos + 1 < input.length && input[pos + 1] == '|' -> {
                    ...
                    tokens.add(createToken(tokenType, char.toString(), startPos, startLine, startColumn))
                    currentColumn++
                    pos++
                }
            }
