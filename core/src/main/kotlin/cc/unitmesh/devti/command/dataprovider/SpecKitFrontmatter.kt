...
/**
 * Represents the frontmatter section of a SpecKit prompt file.
 * 
 * SpecKit prompt files (e.g., speckit.plan.prompt.md) can contain YAML frontmatter
...
data class SpecKitFrontmatter(
    ...
    companion object {
         ...
         */
        fun parse(markdown: String): Pair<SpecKitFrontmatter?, String> {
        ...
        /**
         * Parse YAML content into SpecKitFrontmatter
         */
        private fun parseYaml(yamlContent: String): SpecKitFrontmatter {
            ...
            val additionalFields = data.filterKeys { it !in listOf("description", "variables") }
            
            return SpecKitFrontmatter(
